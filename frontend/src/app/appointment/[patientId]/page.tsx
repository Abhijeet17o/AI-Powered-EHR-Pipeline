    ...
    const processConsultation = async (audioBlob: Blob) => {
        try {
            ...
            if (result.success) {
                ...
                setTranscription(result.transcript || null);
                    ...
                    {transcription && (
                        <div className="card">
                            <h3 style={{ marginBottom: "1rem" }}>
                                <NoteIcon className="inline mr-2" /> Transcription
                            </h3>
                            <div className="bg-tertiary border border-gray-700 rounded-lg p-4 text-sm text-gray-200 whitespace-pre-wrap max-h-48 overflow-y-auto leading-relaxed">
                                {transcription}
                            </div>
                        </div>
                    )}
